"Resource/UI/DropDownServerType.res"
{
	...
	"BtnListen"
	{
		...
		"navDown"				"BtnGroup" [$WIN32]
		"navDown"				"BtnOfficial" [$X360]
	...
	"BtnGroup" [$WIN32]
	{
		...
		"navUp"				"BtnListen"
		"navDown"			"BtnOfficial"
		"labelText"			"#L4D360UI_Lobby_ServerType_Group"
		"tooltiptext"			"#L4D360UI_Lobby_Change_ServerType_Group_Tip"
		"disabled_tooltiptext"		"#L4D360UI_Lobby_Change_ServerType_Group_Disabled_Tip"
		"style"				"FlyoutMenuButton"
		"command"			"#L4D360UI_ServerType_Group"
		"EnableCondition" 		"LiveRequired"		
	}
